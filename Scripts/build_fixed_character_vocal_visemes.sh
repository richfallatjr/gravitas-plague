...
DRIVER="${PROJECT_DIR}/Scripts/generate_fixed_character_vocal_visemes.py"
SOURCE="${REPOSITORY_DIR}/Tools/FixedCharacterVocalVisemeCompiler/main.swift"
BUILD_DIR="${REPOSITORY_DIR}/.build/fixed-character-vocal-viseme-compiler"
EXECUTABLE="${BUILD_DIR}/FixedCharacterVocalVisemeCompiler"
